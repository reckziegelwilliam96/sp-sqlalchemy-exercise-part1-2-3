...
post3 = Post(title="Waking Up to Thunder", content='The foundation of my house shook me awake this morning', user=user1)
post4 = Post(title="Feeling Sick Today", content="Couldn't make it into work today", user=user3)
post5 = Post(title="I hate DirecTV", content="My signal is terrible at my house. I'm switching providers", user=user4)
post6 = Post(title="I saw butterflies in my garden", content="There were rare Blue Butterflies on my window this morning", user=user3)

# Add base tags
tag1 = Tag(name="New")
tag2 = Tag(name="Hot Take")
tag3 = Tag(name="Happy")
tag4 = Tag(name="Sad")
...
posttag5 = PostTag(post_id=3, tag_id=3)
posttag6 = PostTag(post_id=3, tag_id=4)
posttag7 = PostTag(post_id=4, tag_id=3)
posttag8 = PostTag(post_id=5, tag_id=4)
posttag9 = PostTag(post_id=6, tag_id=3)
